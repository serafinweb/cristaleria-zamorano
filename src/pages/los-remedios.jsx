...
export default function LosRemedios() {
  return (
    <div className="page">
      <Helmet>
        <title>Cristalería en Los Remedios | Servicio Urgente y Cristales a Medida</title>
        <meta
          name="description"
          content="Cristalería en Los Remedios con servicio urgente. Instalación y reparación de cristales, espejos, mamparas y ventanas de aluminio. Atención inmediata y presupuesto en 24h."
        />
        <link rel="canonical" href="https://cristaleriasevilla.com/los-remedios" />
        <script type="application/ld+json">
          {`
          {
            ...
            "address": {
              "@type": "PostalAddress",
              "addressLocality": "Los Remedios, Sevilla",
              "addressRegion": "Andalucía",
              "addressCountry": "ES"
            },
            "url": "https://cristaleriasevilla.com/los-remedios",
            "telephone": "+34955631356",
            "priceRange": "€€",
            "description": "Cristalería en Los Remedios con servicio urgente. Instalación y reparación de cristales, espejos, mamparas y ventanas de aluminio."
          }
          `}
        </script>
      </Helmet>
        ...
        <section className="cta-imagen">
          ...
          <div className="cta-imagen-grid">
            ...
            <div className="cta-imagen-foto">
              <img
                src={trabajoCristal}
                alt="Trabajo de cristalería profesional en Los Remedios"
              />
            </div>
          </div>
        </section>
