...
export default function SevillaEste() {
  return (
    <div className="page">
      <Helmet>
        <title>Cristalería en Sevilla Este | Servicio Urgente y Cristales a Medida</title>
        <meta
          name="description"
          content="Cristalería en Sevilla Este con servicio urgente. Instalación y reparación de cristales, espejos, mamparas y ventanas de aluminio. Atención inmediata y presupuesto en 24h."
        />
        <link rel="canonical" href="https://cristaleriasevilla.com/sevilla-este" />
        <script type="application/ld+json">
          {`
          {
            ...
            "address": {
              "@type": "PostalAddress",
              "addressLocality": "Sevilla Este, Sevilla",
              "addressRegion": "Andalucía",
              "addressCountry": "ES"
            },
            "url": "https://cristaleriasevilla.com/sevilla-este",
            "telephone": "+34955631356",
            "priceRange": "€€",
            "description": "Cristalería en Sevilla Este con servicio urgente. Instalación y reparación de cristales, espejos, mamparas y ventanas de aluminio."
          }
          `}
        </script>
      </Helmet>
        ...
        <section className="cta-imagen">
          ...
          <div className="cta-imagen-grid">
            ...
            <div className="cta-imagen-foto">
              <img
                src={trabajoCristal}
                alt="Trabajo de cristalería profesional en Sevilla Este"
              />
            </div>
          </div>
        </section>
